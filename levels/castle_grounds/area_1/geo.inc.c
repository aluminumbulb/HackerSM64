...
const GeoLayout castle_grounds_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 28, -976, -37, castle_grounds_dl_DeathPlane_mesh_layer_5),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_grounds_dl_Ground_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
