...
const GeoLayout bbh_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -33, 8, 3, bbh_dl_Ball_Pit_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 28, -10951, -37, bbh_dl_DeathPlane_mesh_layer_5),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
