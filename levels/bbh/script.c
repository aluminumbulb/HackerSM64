...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(MODEL_MAD_PIANO, 2, 333, 1589, 0, 0, 0, 0x00000000, bhvMadPiano),
		OBJECT(MODEL_NONE, 657, 350, 1553, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 657, 350, 1553),
