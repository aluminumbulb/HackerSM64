...
const GeoLayout ttc_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -33, 8, 3, ttc_dl_Ball_Pit_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 28, -1531, -37, ttc_dl_DeathPlane_mesh_layer_5),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
